...
The `home-routes` handler in the `bolsa-front.routes.home` namespace
...
The `home-page` function will in turn call the `bolsa-front.layout/render` function
...
The rest of this page is rendered by ClojureScript found in the `src/cljs/bolsa_front/core.cljs` file.



<p class="title is-5">Organizing the routes</p>

The routes are aggregated and wrapped with middleware in the `bolsa-front.handler` namespace:
...
Request middleware functions are located under the `bolsa-front.middleware` namespace.

This namespace is reserved for any custom middleware for the application. Some default middleware is
already defined here. The middleware is assembled in the `wrap-base` function.

Middleware used for development is placed in the `bolsa-front.dev-middleware` namespace found in
